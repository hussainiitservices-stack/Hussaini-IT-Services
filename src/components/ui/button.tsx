...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 shadow-elegant-sm hover:shadow-elegant-md",
        destructive:
        ...
        gold:
          "bg-accent text-accent-foreground hover:bg-gold-dark shadow-gold hover:shadow-elegant-lg font-semibold",
        "gold-outline":
          "border-2 border-accent bg-transparent text-accent hover:bg-accent hover:text-accent-foreground",
        hero:
          "bg-accent text-accent-foreground hover:bg-gold-dark shadow-gold hover:shadow-elegant-lg font-semibold text-base",
        "hero-outline":
        ...
        nav:
          "text-foreground/80 hover:text-foreground hover:bg-transparent font-medium",
        "nav-light":
          "text-primary-foreground/80 hover:text-primary-foreground hover:bg-transparent font-medium",
      },
      size: {
